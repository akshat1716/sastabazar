...
const dropshippingProducts = [
  ...
  },
  {
    ...
    description:
      "Ultra-soft premium cotton t-shirt with minimalist design. Perfect for everyday wear with exceptional comfort and breathability.",
  ...
  },
  {
    ...
    description:
      "Advanced smart fitness watch with heart rate monitoring, GPS tracking, and 7-day battery life. Perfect for fitness enthusiasts and health-conscious individuals.",
...
async function addDropshippingProducts() {
  try {
    ...
    console.log(
      `✅ Successfully added ${products.length} dropshipping products!`,
    );
    console.log("\n📦 Product Details:");
    console.log("==================");
    ...
    console.log(
      `Average profit per product: ₹${Math.round(totalProfit / products.length)}`,
    );
