...
const homeProduct = {
  ...
  description: 'Beautiful ceramic dinnerware set perfect for modern dining. Includes plates, bowls, and mugs made from high-quality ceramic with elegant design.',
...
async function addProduct() {
  try {
    ...
    console.log(`💰 Price: ₹${homeProduct.basePrice} (Sale: ₹${homeProduct.salePrice})`);
