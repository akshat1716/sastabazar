...
async function processChatMessage(message, conversationHistory, user) {
  ...
  switch (intent) {
    case "greeting":
      response.message =
        "Hello! I'm your AI shopping assistant. What are you looking for today? I can help you find products across all categories.";
    ...
    case "style_advice": {
      response.message =
        "I'd be happy to help you with style recommendations! What aesthetic are you going for? (e.g., Modern, Industrial, Artisan, Minimalist, Luxury)";
      break;
    }
    ...
    default:
      response.message =
        "I understand you're looking for something. Could you tell me more about what you need? I can help with specific products, style advice, or category recommendations.";
  }
