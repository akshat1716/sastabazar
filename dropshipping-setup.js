...
const sampleDropshippingProducts = [
  ...
  },
  {
    ...
    description: 'Ultra-soft premium cotton t-shirt with minimalist design. Perfect for everyday wear with exceptional comfort.',
...
async function addDropshippingProducts() {
  try {
    ...
    products.forEach((product, index) => {
      ...
      console.log(`   Profit: ₹${product.basePrice - product.supplierInfo.supplierPrice}`);
