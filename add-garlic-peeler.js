...
async function addGarlicPeelerProduct() {
  try {
    const newProduct = new Product({
      ...
      description: 'Premium stainless steel garlic peeler set with dual functionality. Perfect for mincing and peeling garlic efficiently. Made from durable materials for long-lasting use.',
    ...
    console.log(`💰 Your Price: ₹${savedProduct.basePrice} (Sale: ₹${savedProduct.salePrice})`);
