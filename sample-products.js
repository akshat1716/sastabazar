...
const sampleProducts = [
  // Apparel Category
  {
    ...
    category: "apparel",
    shortDescription:
      "Ultra-soft premium cotton t-shirt with minimalist design.",
    description:
      "Ultra-soft premium cotton t-shirt with minimalist design. Perfect for everyday wear with exceptional comfort and breathability. Made from 100% organic cotton with a comfortable fit that's perfect for any occasion.",
    basePrice: 1299,
    salePrice: 999,
    isOnSale: true,
    isNewArrival: false,
  ...
  },
  {
    ...
    description:
      "Classic denim jacket with modern tailoring. Features premium denim construction with comfortable fit and timeless style. Perfect for layering in any season with a versatile design that goes with everything.",
    basePrice: 3499,
    salePrice: 2799,
    isOnSale: true,
    isNewArrival: false,
  ...
  // Home Goods Category
  {
    ...
    description:
      "Handcrafted ceramic vase with minimalist design. Perfect for displaying fresh flowers or as a standalone decorative piece. Each vase is uniquely crafted by skilled artisans using traditional techniques.",
    basePrice: 899,
    salePrice: 699,
    isOnSale: true,
    isNewArrival: false,
  ...
  },
  {
    ...
    description:
      "Luxury 100% cotton bedding set with elegant design. Includes duvet cover, pillowcases, and fitted sheet for complete bedroom transformation. Made from premium Egyptian cotton for ultimate comfort.",
    basePrice: 2499,
    salePrice: 1999,
    isOnSale: true,
    isNewArrival: false,
  ...
  // Tech Accessories Category
  {
    ...
    description:
      "Premium wireless headphones with noise cancellation. Features crystal clear sound quality and comfortable over-ear design for extended listening sessions. Perfect for work, travel, or daily use.",
    basePrice: 3999,
    salePrice: 2999,
    isOnSale: true,
    isNewArrival: true,
  ...
  },
  {
    ...
    description:
      "Elegant aluminum phone stand with minimalist design. Perfect for desk organization and hands-free viewing with adjustable viewing angles. Made from premium aluminum for durability and style.",
    basePrice: 599,
    salePrice: 449,
    isOnSale: true,
    isNewArrival: true,
  ...
  // Art & Prints Category
  {
    ...
    category: "art-prints",
    shortDescription:
      "Limited edition abstract art print on premium archival paper.",
    description:
      "Limited edition abstract art print on premium archival paper. Features bold geometric patterns and vibrant colors perfect for modern interiors. Each print is numbered and comes with a certificate of authenticity.",
    basePrice: 1299,
    salePrice: 999,
    isOnSale: true,
    isNewArrival: false,
  ...
  },
  {
    ...
    category: "art-prints",
    shortDescription:
      "Stunning minimalist photography print capturing urban architecture.",
    description:
      "Stunning minimalist photography print capturing urban architecture. Printed on museum-quality paper with exceptional detail and contrast. Perfect for modern homes and offices seeking sophisticated wall art.",
    basePrice: 899,
    salePrice: 699,
    isOnSale: true,
    isNewArrival: true,
