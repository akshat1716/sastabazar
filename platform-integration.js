...
const platformProducts = [
  // TradeIndia products
  {
    ...
    description:
      "High-quality cotton bed sheets set with premium finish. Perfect for comfortable sleep and home decor.",
  ...
  // IndiaMART products
  {
    ...
    description:
      "Energy-efficient smart LED bulbs with WiFi connectivity. Control brightness and color from your smartphone.",
...
async function addPlatformProducts() {
  try {
    ...
    console.log(
      `✅ Successfully added ${products.length} products from your platforms!`,
    );
    console.log("\n📦 Product Details:");
    console.log("==================");
    ...
    products.forEach((product, index) => {
      ...
      console.log(
        `   Profit: ₹${profit} (${product.platformInfo.profitMargin}% margin)`,
      );
